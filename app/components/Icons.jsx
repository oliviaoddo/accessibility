             ...
             <div className='section'>
                ...
                <div className='row'>
                    ...
                    <div className='col m6'>
                         <div className="card grey lighten-4">
                            <div className="card-content white-text">
                                <a id="test" href='#'>Start Test <i className="fa fa-hourglass-half" aria-hidden="true" title="The test is timed."></i>
                ...
                <div className='row'>
                            ...
                            <div className="card-content white-text">
                                ...
                                <tbody>
                                  <tr>
                                    <td>Macbook Pro</td>
                                    <td>$2,399.00</td>
                                    <td><a><i className="fa fa-trash-o" aria-hidden="true" title="Delete this item?"></i></a></td>
                                  </tr>
                                  <tr>
                                    <td>iPhone 7</td>
                                    <td>$649.00</td>
                    ...
                    <div className='col m6'>
                         <div className="card grey lighten-4">
                            <div className="card-content white-text">
                                <a href="#" aria-label='View the items in your cart'>
